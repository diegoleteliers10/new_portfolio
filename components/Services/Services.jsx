...
const Services = () => {
  return (
    <div id="services" className='mt-[3.5rem] p-[3.5rem] services-sm'>
      <h2 className="text-[#B5734C] text-center"> Services </h2>
      <div className='mt-10 flex gap-[4rem] service_container-sm'>

        <div className='bg-[#363636] p-6 rounded-xl'>
          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24" className='w-full mb-4 fill-[#ffffff]'><path d="m7.375 16.781 1.25-1.562L4.601 12l4.024-3.219-1.25-1.562-5 4a1 1 0 0 0 0 1.562l5 4zm9.25-9.562-1.25 1.562L19.399 12l-4.024 3.219 1.25 1.562 5-4a1 1 0 0 0 0-1.562l-5-4zm-1.649-4.003-4 18-1.953-.434 4-18z"></path></svg>
        ...
        <div className='bg-[#363636] p-6 rounded-xl'>
          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24" className='w-full mb-4 fill-[#ffffff]'><path d="M18 22c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2H8c-1.103 0-2 .897-2 2v16c0 1.103.897 2 2 2h10zm-5-5a1 1 0 1 1 0 2 1 1 0 1 1 0-2z"></path></svg>
