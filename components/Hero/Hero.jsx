      ...
      <div className='hero-text_container'>
          ...
          <li className="socials">
            <a href="https://github.com/diegoleteliers10" target="_blank" rel='noreferrer'>
              <Image src='/github.svg' alt='github' width={30} height={30} className='hover:scale-125 transition duration-200'/>
          ...
          <li className="socials">
            <a href="https://www.linkedin.com/in/diegoleteliers10/" target="_blank" rel='noreferrer'>
              <Image src='/linkedin.svg' alt='linkedin' width={30} height={30} className='hover:scale-125 transition duration-200'/>
          ...
          <li className="socials">
            <a href="mailto:diegoleteliers10@gmail.com">
              <Image src='/email.svg' alt='email' width={30} height={30} className='hover:scale-125 transition duration-200'/>
